...
type VkFaultData* = object
  sType*: VkStructureType = StructureTypeFaultData
  pNext*: pointer
...
type VkFaultCallbackInfo* = object
  sType*: VkStructureType = StructureTypeFaultCallbackInfo
  pNext*: pointer
  faultCount*: uint32
...
type VkPipelineOfflineCreateInfo* = object
  sType*: VkStructureType = StructureTypePipelineOfflineCreateInfo
  pNext*: pointer
  pipelineIdentifier*: array[VK_UUID_SIZE, uint8]
...
type VkPhysicalDeviceVulkanSC10Properties* = object
  sType*: VkStructureType = StructureTypePhysicalDeviceVulkanSc10Properties
  pNext*: pointer
...
type VkPipelinePoolSize* = object
  sType*: VkStructureType = StructureTypePipelinePoolSize
  pNext*: pointer
  poolEntrySize*: VkDeviceSize
...
type VkDeviceObjectReservationCreateInfo* = object
  sType*: VkStructureType = StructureTypeDeviceObjectReservationCreateInfo
  pNext*: pointer
...
type VkCommandPoolMemoryReservationCreateInfo* = object
  sType*: VkStructureType = StructureTypeCommandPoolMemoryReservationCreateInfo
  pNext*: pointer
...
type VkCommandPoolMemoryConsumption* = object
  sType*: VkStructureType = StructureTypeCommandPoolMemoryConsumption
  pNext*: pointer
...
type VkPhysicalDeviceVulkanSC10Features* = object
  sType*: VkStructureType = StructureTypePhysicalDeviceVulkanSc10Features
  pNext*: pointer
