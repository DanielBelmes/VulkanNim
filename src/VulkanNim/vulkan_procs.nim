...
proc vkGetQueryPoolResults*(device: VkDevice, queryPool: VkQueryPool, firstQuery: uint32, queryCount: uint32, dataSize: uint, pData: ptr void, stride: VkDeviceSize, flags: VkQueryResultFlags): VkResult {.cdecl, importc, dynlib: vkDLL.}
...
proc vkGetPipelineCacheData*(device: VkDevice, pipelineCache: VkPipelineCache, pDataSize: ptr uint, pData: ptr void): VkResult {.cdecl, importc, dynlib: vkDLL.}
...
proc vkDebugReportMessageEXT*(instance: VkInstance, flags: VkDebugReportFlagsEXT, objectType: VkDebugReportObjectTypeEXT, `object`: uint64, location: uint, messageCode: int32, pLayerPrefix: ptr char, pMessage: ptr char): void {.cdecl, importc, dynlib: vkDLL.}
...
proc vkGetValidationCacheDataEXT*(device: VkDevice, validationCache: VkValidationCacheEXT, pDataSize: ptr uint, pData: ptr void): VkResult {.cdecl, importc, dynlib: vkDLL.}
...
proc vkGetShaderInfoAMD*(device: VkDevice, pipeline: VkPipeline, shaderStage: VkShaderStageFlagBits, infoType: VkShaderInfoTypeAMD, pInfoSize: ptr uint, pInfo: ptr void): VkResult {.cdecl, importc, dynlib: vkDLL.}
...
proc vkWriteAccelerationStructuresPropertiesKHR*(device: VkDevice, accelerationStructureCount: uint32, pAccelerationStructures: ptr VkAccelerationStructureKHR, queryType: VkQueryType, dataSize: uint, pData: ptr void, stride: uint): VkResult {.cdecl, importc, dynlib: vkDLL.}
...
proc vkGetRayTracingShaderGroupHandlesKHR*(device: VkDevice, pipeline: VkPipeline, firstGroup: uint32, groupCount: uint32, dataSize: uint, pData: ptr void): VkResult {.cdecl, importc, dynlib: vkDLL.}
proc vkGetRayTracingCaptureReplayShaderGroupHandlesKHR*(device: VkDevice, pipeline: VkPipeline, firstGroup: uint32, groupCount: uint32, dataSize: uint, pData: ptr void): VkResult {.cdecl, importc, dynlib: vkDLL.}
proc vkGetAccelerationStructureHandleNV*(device: VkDevice, accelerationStructure: VkAccelerationStructureNV, dataSize: uint, pData: ptr void): VkResult {.cdecl, importc, dynlib: vkDLL.}
...
proc vkGetEncodedVideoSessionParametersKHR*(device: VkDevice, pVideoSessionParametersInfo: ptr VkVideoEncodeSessionParametersGetInfoKHR, pFeedbackInfo: ptr VkVideoEncodeSessionParametersFeedbackInfoKHR, pDataSize: ptr uint, pData: ptr void): VkResult {.cdecl, importc, dynlib: vkDLL.}
...
proc vkGetDescriptorEXT*(device: VkDevice, pDescriptorInfo: ptr VkDescriptorGetInfoEXT, dataSize: uint, pDescriptor: ptr void): void {.cdecl, importc, dynlib: vkDLL.}
...
proc vkWriteMicromapsPropertiesEXT*(device: VkDevice, micromapCount: uint32, pMicromaps: ptr VkMicromapEXT, queryType: VkQueryType, dataSize: uint, pData: ptr void, stride: uint): VkResult {.cdecl, importc, dynlib: vkDLL.}
...
proc vkGetShaderBinaryDataEXT*(device: VkDevice, shader: VkShaderEXT, pDataSize: ptr uint, pData: ptr void): VkResult {.cdecl, importc, dynlib: vkDLL.}
